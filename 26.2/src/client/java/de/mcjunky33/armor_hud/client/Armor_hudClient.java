    ...
    public void onInitializeClient() {
        ...
        net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (keyBindOpenConfig.consumeClick()) {
                ...
                // changed for MC 26.2: Minecraft.setScreen/Minecraft.screen moved to Minecraft.gui.setScreen()/Minecraft.gui.screen()
                client.gui.setScreen(new ModMenuIntegration.SimpleConfigScreen(client.gui.screen()));
            }
