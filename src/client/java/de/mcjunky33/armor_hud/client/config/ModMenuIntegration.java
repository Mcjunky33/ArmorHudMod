                    ...
                    ButtonWidget.builder(
                                    ...
                                    btn -> {
                                        ...
                                        btn.setMessage(Text.literal(
                                                tr("orientation") + ": " + (newVertical ? tr("vertical") : tr("horizontal"))
                                        ));

                                        // Alle alten Offset-Widgets entfernen
                                        ...
                                        // Neu initialisieren für den aktuellen Mode
                                        this.init();
                                    }
                            )
                            .dimensions(toggleStartX, toggleY, btnW, btnH)
                            .build()
            );
