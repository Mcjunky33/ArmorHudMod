...
public class ArmorHudConfig {
    ...
    private boolean alwaysShowTooltipDurability = true;
    ...
    private static ArmorHudConfig loadOrCreate() {
        if (Files.exists(CONFIG_PATH)) {
            try {
                ...
                if (loaded.configVersion < CURRENT_CONFIG_VERSION) {
                    System.out.println("[ArmorHUD] Outdated config found (Version " + loaded.configVersion + "). Resetting to defaults for Version " + CURRENT_CONFIG_VERSION);
                    ArmorHudConfig freshConfig = createDefaultConfig();
                    freshConfig.saveConfig();
                    return freshConfig;
                }
        ...
        ArmorHudConfig newConfig = createDefaultConfig();
    ...
    private static ArmorHudConfig createDefaultConfig() {
        ...
        config.visible = true;
        config.durabilityDisplayMode = 1;
        ...
        config.showHandDurability = true;
        config.alwaysShowTooltipDurability = true;

        // Durability defaults
        config.showDurabilityBar = true;
        config.showDurabilityText = true;
        config.showDurabilityPercent = false;
        config.useHotbarTexture = true;
    ...
    public void resetToDefaults() {
        ...
        showHandDurability = true;
        alwaysShowTooltipDurability = true;

        showDurabilityBar = true;
        showDurabilityText = true;
        showDurabilityPercent = false;

        useHotbarTexture = true;
    ...
    public boolean isAlwaysShowTooltipDurability() { return alwaysShowTooltipDurability; }
    public void setAlwaysShowTooltipDurability(boolean value) { this.alwaysShowTooltipDurability = value; saveConfig(); }
