...
public class ArmorHudOverlay {
    ...
    public void renderArmorUI(DrawContext context) {
        ...
        // ECHTE ARMOR (über Slots, wie vorher)
    ...
    private void drawBoxAndArmor(
        ...
        if (mode == 0) {
            ...
            drawDurabilityTextSimple(
                    context, boxX, boxY, boxSize,
                    armorItem, offsetXNumber, offsetYNumber, false
            );
        } else if (mode == 2) {
            drawDurabilityTextSimple(
                    context, boxX, boxY, boxSize,
                    armorItem, offsetXNumber, offsetYNumber, true
            );
        }
    }
    ...
    public void drawDurabilityBar(DrawContext context, int x, int y, int width, ItemStack item) {
        ...
        float ratio = (maxDamage - item.getDamage()) / (float) maxDamage;
        int barWidth = 13;
